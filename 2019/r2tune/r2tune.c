...
void check_win(UBYTE win) 
{
	...
	if (win==11) {
		HIDE_BKG;
		HIDE_SPRITES;
		gprintf("You unlocked the secret!{%s_%s}", a, b);
	}
}
...
void dialtone(UWORD dtmf_on, UWORD dtmf_off, char str[20])
{
	UBYTE i = 0;
	UBYTE j = 0;
	const unsigned char code[] = {'1','A','5','7','B','A','1','A','5','7','C'};
